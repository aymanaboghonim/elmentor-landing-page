  ...
  return (
    <section id="founder" className="founder-section" aria-labelledby="founder-title">
      <div className="founder-container">
        ...
        <div className="founder-content-wrapper">          <div className="founder-image-container">
            <img 
              src={founderImage} 
            ...
            <div className="founder-cta-section">
              ...
              <div className="founder-cta-buttons">
                <Button 
                  ...
                  aria-label="Connect with Mohamed Radwan on LinkedIn"
                >
                  Connect on LinkedIn
                </Button>
                <Button 
                  ...
                  aria-label="Contact Mohamed through the contact form"
                >
                  Get in Touch
                </Button>
              </div>
