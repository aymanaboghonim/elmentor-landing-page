...
import elmentorLogo from '../assets/images/elmentor-logo.png';
import Button from '../components/Button';

const Footer = () => {
  const currentYear = new Date().getFullYear();

  return (    <footer className="elmentor-footer" role="contentinfo">
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-cta">
            ...
            <p className="footer-cta-text">Join our community and start your mentorship journey today.</p>
            <Button 
              variant="secondary" 
              size="medium"
